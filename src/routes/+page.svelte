...
<section class="w-full md:w-2/3 flex flex-col items-center px-3">
	...
	<article class="flex flex-col shadow my-4">
		...
		<div class="bg-white flex flex-col justify-start p-6">
			<a href="#" class="text-blue-700 text-sm font-bold uppercase pb-4">{content.category.name}</a>
			<a href="#" class="text-3xl font-bold hover:text-gray-700 pb-4">{content.title}</a>
			...
			<a href="#" class="pb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus quis porta
				...
				posuere magna..</a>
			<a href="{content.id}" class="uppercase text-gray-800 hover:text-black">continue reading <i
